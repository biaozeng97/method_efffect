...
# 定义文件路径
file_path <- "D:/U盘数据 20220115备份/中心博士/学术会议/IMPS 2023/data analysis/Method Effect/simulation of GRM models/combined_bias_rmse.xlsx"

# 导出csv 文件
csv_file_path <- "D:/U盘数据 20220115备份/中心博士/学术会议/IMPS 2023/data analysis/Method Effect/simulation of GRM models/combined_bias_rmse.csv"
write.csv(combined_bias_rmse, csv_file_path, row.names = FALSE)

# 导出theta bias rmse cor csv 文件
csv_file_path <- "D:/U盘数据 20220115备份/中心博士/学术会议/IMPS 2023/data analysis/Method Effect/simulation of GRM models/combined_theta_bias_rmse_cor_onefactor.csv"
write.csv(combined_theta_bias_rmse_cor, csv_file_path)
...
###########################
###  Bi-factor model (delete un converged and exclude it from final results)  ###
###########################
...
# 导出item bias rmse csv 文件
csv_file_path <- "D:/U盘数据 20220115备份/中心博士/学术会议/IMPS 2023/data analysis/Method Effect/simulation of GRM models/combined_bias_rmse_bifactor.csv"
write.csv(combined_bias_rmse, csv_file_path, row.names = FALSE)

# 导出theta bias rmse cor csv 文件
csv_file_path <- "D:/U盘数据 20220115备份/中心博士/学术会议/IMPS 2023/data analysis/Method Effect/simulation of GRM models/combined_theta_bias_rmse_cor_bifactor.csv"
write.csv(combined_theta_bias_rmse_cor, csv_file_path)
